...
class AboutSymbols < Neo::Koan
  ...
  # Answer: https://stackoverflow.com/questions/4573991/why-is-it-not-a-good-idea-to-dynamically-create-a-lot-of-symbols-in-ruby-for-ve
  # memory consumption of each symbol since they are immutable
end
